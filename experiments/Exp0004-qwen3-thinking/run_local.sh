#!/bin/bash
# Local (non-SLURM) inference for Exp0004 — Qwen3-Omni-30B-A3B-Thinking
# Processes all samples sequentially using HF dataset mode.
#
# Usage:
#   ./experiments/Exp0004-qwen3-thinking/run_local.sh
#   SPLIT=train ./experiments/Exp0004-qwen3-thinking/run_local.sh
#   LIMIT=5 ./experiments/Exp0004-qwen3-thinking/run_local.sh
...
echo "=========================================="
echo "Local run:        Exp0004 — Qwen3-Omni-30B Thinking"
echo "Host:             $(hostname)"
