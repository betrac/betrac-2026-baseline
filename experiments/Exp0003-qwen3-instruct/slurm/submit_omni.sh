...
# Submit Qwen3-Omni-30B-A3B-Instruct inference array job + combine job for Exp0003
# Run from: experiments/Exp0003-qwen3-instruct/
#
# Usage:
...
#   MODEL_ID          HuggingFace model ID           (default: Qwen/Qwen3-Omni-30B-A3B-Instruct)
#   MODEL_SHORT       Short name for output dir      (default: qwen3-omni-30b-instruct)
...
if [ ! -f "slurm/run_omni_hf.slurm" ]; then
    echo "ERROR: Must run from experiments/Exp0003-qwen3-instruct/"
    echo "  cd $(cd ../.. && pwd)/experiments/Exp0003-qwen3-instruct"
...
# ---------------------------------------------------------------------------
echo "=========================================="
echo "Exp0003 — Qwen3-Omni-30B Instruct Submission"
echo "=========================================="
...
echo "Monitor with:"
echo "  squeue -u \$USER"
echo "  tail -f slurm/logs-slurm/slurm-Exp0003-omni-qwen3-instruct_${ARRAY_JOB_ID}_<TASK>.out"
