#!/bin/bash
# Local (non-SLURM) inference for Exp0002 — Qwen2.5-Omni-7B
# Processes all samples sequentially using HF dataset mode.
#
# Usage:
#   ./experiments/Exp0002-qwen25-7b/run_local.sh
#   SPLIT=train ./experiments/Exp0002-qwen25-7b/run_local.sh
#   LIMIT=5 ./experiments/Exp0002-qwen25-7b/run_local.sh
...
echo "=========================================="
echo "Local run:        Exp0002 — Qwen2.5-Omni-7B"
echo "Host:             $(hostname)"
