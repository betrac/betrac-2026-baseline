#!/bin/bash
# Local (non-SLURM) inference for Exp0001 — Qwen2.5-Omni-3B
# Processes all samples sequentially using HF dataset mode.
#
# Usage:
#   ./experiments/Exp0001-qwen25-3b/run_local.sh                   # defaults
#   SPLIT=train ./experiments/Exp0001-qwen25-3b/run_local.sh       # train split
#   LIMIT=5 ./experiments/Exp0001-qwen25-3b/run_local.sh           # first 5 samples
#   FLASH_ATTN=1 ./experiments/Exp0001-qwen25-3b/run_local.sh      # Flash Attention 2
...
# ---------------------------------------------------------------------------
echo "=========================================="
echo "Local run:        Exp0001 — Qwen2.5-Omni-3B"
echo "Host:             $(hostname)"
...
# ---------------------------------------------------------------------------
# GPU utilization monitoring (background, optional)
# ---------------------------------------------------------------------------
